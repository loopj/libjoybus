...
#define JOYBUS_CMD_N64_PAK_READ_TX        3     ///< N64 pak read command length
#define JOYBUS_CMD_N64_PAK_READ_RX        33    ///< N64 pak read response length

/**
 * N64 pak write command
 */
#define JOYBUS_CMD_N64_PAK_WRITE          0x03
#define JOYBUS_CMD_N64_PAK_WRITE_TX       35    ///< N64 pak write command length
#define JOYBUS_CMD_N64_PAK_WRITE_RX       1     ///< N64 pak write response length
