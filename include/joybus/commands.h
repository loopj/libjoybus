...
#define JOYBUS_CMD_N64_EEPROM_READ_BLOCK      0x04
#define JOYBUS_CMD_N64_EEPROM_WRITE_BLOCK     0x05
...
#define JOYBUS_CMD_N64_EEPROM_READ_BLOCK_TX   2
#define JOYBUS_CMD_N64_EEPROM_READ_BLOCK_RX   8
#define JOYBUS_CMD_N64_EEPROM_WRITE_BLOCK_TX  10
#define JOYBUS_CMD_N64_EEPROM_WRITE_BLOCK_RX  1
...
#define JOYBUS_ID_64GB_LINK_CABLE             0x0003  ///< 64GB Link Cable (Unreleased)
#define JOYBUS_ID_N64_GBA_LINK_CABLE          0x0004  ///< GBA Link Cable (DOL-011)
#define JOYBUS_ID_CART_RTC                    0x0010  ///< Cartridge-based RTC
#define JOYBUS_ID_CART_EEPROM_4KBIT           0x0080  ///< Cartridge-based 4 kbit (512 B) EEPROM
#define JOYBUS_ID_CART_EEPROM_16KBIT          0x00C0  ///< Cartridge-based 16 kbit (2 KB) EEPROM
...
#define JOYBUS_ID_GCN_WIRELESS_ID_HI          0xC000  ///< Wireless ID bits 9–8 (in byte 1 of ID field)

// N64 identify status values (Standard N64 Controller)
...
// N64 identify status values (Voice Recognition Unit)
...
// GCN identify status flags (wireless controllers)
#define JOYBUS_ID_GCN_WIRELESS_ID_LO          0xFF    ///< Wireless ID bits 7–0 (in byte 2 of ID field)
